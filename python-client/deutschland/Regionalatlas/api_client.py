...
from deutschland.Regionalatlas import rest
...
from deutschland.Regionalatlas.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.query  # this is an instance of the class Endpoint
        api_instance.query()  # this invokes api_instance.query.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.query.callable or self.callable in this class
